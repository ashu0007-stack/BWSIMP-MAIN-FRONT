    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 p-4 md:p-6">
      ...
      {!selectedPackage && (
        <div className="space-y-4">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-800 mb-2">Length Progress Dashboard</h1>
            <p className="text-gray-600">Track and manage project Length efficiently</p>
          </div>
